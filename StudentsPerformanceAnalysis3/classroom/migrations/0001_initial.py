# Generated by Django 2.1.5 on 2019-04-03 11:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('career_title', models.CharField(default='', max_length=20)),
                ('career_description', models.CharField(default='', max_length=1000)),
                ('career_subject_category', models.CharField(choices=[('Commercials', 'Commercials'), ('Arts', 'Arts'), ('Sciences', 'Sciences')], default='', max_length=20)),
                ('career_image', models.ImageField(default='', upload_to='career_image')),
            ],
        ),
        migrations.CreateModel(
            name='CareerPersonalityCategory',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_name', models.CharField(choices=[('Commercials', 'Commercials'), ('Arts', 'Arts'), ('Sciences', 'Sciences')], default='', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Day',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='personality_image')),
                ('energy_title', models.CharField(default='', max_length=15)),
                ('energy_description1', models.CharField(default='', max_length=50)),
                ('energy_description2', models.CharField(default='', max_length=50)),
                ('energy_description3', models.CharField(default='', max_length=50)),
                ('energy_description4', models.CharField(default='', max_length=50)),
                ('energy_description5', models.CharField(default='', max_length=50)),
                ('information_title', models.CharField(default='', max_length=15)),
                ('information_description1', models.CharField(default='', max_length=50)),
                ('information_description2', models.CharField(default='', max_length=50)),
                ('information_description3', models.CharField(default='', max_length=50)),
                ('information_description4', models.CharField(default='', max_length=50)),
                ('information_description5', models.CharField(default='', max_length=50)),
                ('decision_title', models.CharField(default='', max_length=15)),
                ('decision_description1', models.CharField(default='', max_length=50)),
                ('decision_description2', models.CharField(default='', max_length=50)),
                ('decision_description3', models.CharField(default='', max_length=50)),
                ('decision_description4', models.CharField(default='', max_length=50)),
                ('decision_description5', models.CharField(default='', max_length=50)),
                ('life_title', models.CharField(default='', max_length=15)),
                ('life_description1', models.CharField(default='', max_length=50)),
                ('life_description2', models.CharField(default='', max_length=50)),
                ('life_description3', models.CharField(default='', max_length=50)),
                ('life_description4', models.CharField(default='', max_length=50)),
                ('life_description5', models.CharField(default='', max_length=50)),
                ('energy_explanation', models.CharField(default='', max_length=500)),
                ('information_explanation', models.CharField(default='', max_length=500)),
                ('decision_explanation', models.CharField(default='', max_length=500)),
                ('life_explanation', models.CharField(blank=True, default='', max_length=500)),
                ('teaching_method1', models.CharField(blank=True, default='', max_length=1000)),
                ('teaching_method2', models.CharField(blank=True, default='', max_length=1000)),
                ('teaching_method3', models.CharField(blank=True, default='', max_length=1000)),
                ('teaching_method4', models.CharField(blank=True, default='', max_length=1000)),
                ('teaching_method5', models.CharField(blank=True, default='', max_length=1000)),
                ('teaching_method6', models.CharField(blank=True, default='', max_length=1000)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Commercials', 'Commercials'), ('Arts', 'Arts'), ('Sciences', 'Sciences')], default='', max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='SubjectAverage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, default='', max_length=45)),
                ...
                ('date_of_birth', models.DateField(blank=True, default=datetime.date.today, verbose_name='Date')),
                ('guardian', models.CharField(blank=True, choices=[('Father', 'Father'), ('Mother', 'Mother'), ('Other', 'Other')], default='', max_length=10)),
                ('guardian_first_name', models.CharField(blank=True, default='', max_length=20)),
                ('guardian_last_name', models.CharField(blank=True, default='', max_length=20)),
                ('guardian_phone_number', models.CharField(default='', max_length=20)),
                ('guardian_email', models.EmailField(blank=True, default='', max_length=100)),
        ...
        migrations.AddField(
            ...
            name='career_personality_category',
            field=models.ManyToManyField(to='classroom.CareerPersonalityCategory'),
        ),
        migrations.AddField(
            model_name='careerfield',
            name='dominant_subjects',
            field=models.ManyToManyField(default='', to='classroom.Subject'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='subjectaverage',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='classroom.Student'),
        ),
        migrations.AddField(
            model_name='categoryaverage',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='classroom.Student'),
        ),
        migrations.AddField(
